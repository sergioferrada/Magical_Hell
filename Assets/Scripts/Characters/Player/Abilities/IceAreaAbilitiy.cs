...
public class IceAreaAbilitiy : PlayerAbility
{
    ...
    protected override void Start()
    {
        ...
        {                         
                                 //  [D]     [CD]     [OS]  
            new SkillLevelStatistics(2.0f,   3.0f,   1.0f),  //Level 1
            new SkillLevelStatistics(2.0f,   2.75f,  1.0f),  //Level 2
            new SkillLevelStatistics(2.5f,   2.75f,  1.1f),  //Level 3
            new SkillLevelStatistics(2.5f,   1.65f,  1.2f), //Level 4
            new SkillLevelStatistics(3.0f,   1.65f,  1.3f), //Level 5
            new SkillLevelStatistics(3.0f,   1.5f,   1.4f), //Level 6
            new SkillLevelStatistics(4.5f,   1.25f,  1.5f), //Level 7
            new SkillLevelStatistics(5.5f,   1.25f,  1.6f), //Level 8
            new SkillLevelStatistics(6.5f,   1.0f,   1.7f),  //Level 9
            new SkillLevelStatistics(7.0f,   1.0f,   1.8f),  //Level 10
        };
